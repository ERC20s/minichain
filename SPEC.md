...
- Not covered yet: balances and double spends, fees, and account state in general. The signature proves consent to THIS transfer, not that it is affordable. Replay is now covered — see "Nonce replay protection" below. Those remaining items are separate cycles.
